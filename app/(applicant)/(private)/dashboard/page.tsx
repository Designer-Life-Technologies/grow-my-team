...
export const metadata: Metadata = {
  title: "Applicant Home | Grow My Team",
  description: "Public applicant landing page",
}
  ...
  return (
    <section className="mx-auto max-w-3xl">
      <h1 className="text-3xl font-bold tracking-tight">
        Private Applicant Dashboard - Will Require Applicant Authentication
      </h1>
      <p className="mt-3 text-muted-foreground">
        This is the public applicant home page. Replace this placeholder text
        with real content, such as an overview of the applicant experience,
